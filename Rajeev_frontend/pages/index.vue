...
console.log('Login inputes :', form.username, form.password )
...
async function onSubmit() {
  ...
  try {
    ...
    // console.log('Login resolved both api in one take, user:', user, 'store token:', auth.token)
    ...
    console.log('Navigation complete (router.push)')
  } catch (err) {
