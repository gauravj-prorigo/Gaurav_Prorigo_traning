<template>
    <section class="admin-dashboard">
            ...
            <div class="users-card">
                <div class="card-header">
                    ...
                    <div class="header-actions">
                        <button class="btn btn-secondary" v-on:click="fetchUsers">
                ...
                <div v-else class="users-list">
                    <div class="user-item" v-for="user in users" :key="user.id">
                        ...
                        <div class="user-actions">
                            <select v-model="user.role" @change="assignRole(user)" class="role-select">
        ...
        <BlogForm v-if="showUserForm" @close="closeBlogForm" @saved="onBlogSaved" />

        <!-- Permissions Modal -->
        <div v-if="showPermissions" class="modal-overlay">
            <div class="permissions-modal">
                <div class="modal-header">
                    <h3>Role Permissions</h3>
                    <button class="btn-close" @click="closePermissions">✖</button>
                </div>

                <div class="modal-body">
                    <div class="perm-card">
                        <h4>Admin</h4>
                        <p class="muted">Has all permissions.</p>
                        <ul>
                            <li>Create, edit, delete any post</li>
                            <li>Assign roles and manage users</li>
                            <li>Access analytics and exports</li>
                        </ul>
                    </div>
                    ...
                    <div class="perm-card">
                        ...
                        <ul>
                            <li>Create posts</li>
                            <li>Edit own posts and others' posts</li>
                    ...
                    <div class="perm-card">
                        ...
                        <ul>
                            <li>Can view posts only</li>
                        </ul>
                    </div>
                </div>

                <div class="modal-footer">
                    <button class="btn btn-primary" @click="closePermissions">Close</button>
                </div>
            </div>
        </div>
    </section>
...
// stray token removed (was causing runtime error during component setup)
// Computed properties for stats
const adminCount = computed(() => users.value.filter(u => u.role === 'admin').length)
const employeeCount = computed(() => users.value.filter(u => u.role === 'employee').length)
const managerCount = computed(() => users.value.filter(u => u.role === 'maneger').length)
